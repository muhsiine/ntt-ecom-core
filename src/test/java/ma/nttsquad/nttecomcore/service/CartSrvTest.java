...
class CartSrvTest {
    ...
    void setUp() {
        ...
        cartSrv = new CartSrvImpl(cartRepository,cartItemRepository,productRepository);
    ...
    void addItemsToCart() {
        ...
        List<CartItemDto> cartItemDtoList = cartSrv.getCartItemsByCartId(1L);
        cartItemDtoList.add(new CartItemDto(2L,productDtoMock,null,8));
    ...
    void saveCart() {
        ...
        CartDto cartDto = cartSrv.saveCart(any());
        assertThat(cartDto)
                .isNotNull()
                .extracting("id")
                .isEqualTo(mockCartDto.getId());
    ...
    void removeItemsFromCart() {
        ...
        CartDto cartDto = cartSrv.removeItemsFromCart(1L, Arrays.asList(1L,2L));
        assertThat(cartDto)
                .isNotNull()
                .extracting("id")
                .isEqualTo(mockCartDto.getId());
