INSERT INTO USER(USER_ID, USERNAME, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, CREATED_AT, IMAGE_URL)
...
INSERT INTO ADDRESS(ADDRESS_ID, ADDRESS_DESC, ZIP_CODE, CITY_ID, USER_ID)
