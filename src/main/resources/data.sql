...
INSERT INTO CATEGORIES(ID, CATEGORY_CODE, ICON) VALUES (1, 'FASHION', '/path1');
INSERT INTO CATEGORIES(ID, CATEGORY_CODE, ICON) VALUES (2, 'ELECTRONICS', '/path1');
INSERT INTO CATEGORIES(ID, CATEGORY_CODE, ICON) VALUES (3, 'HEALTH_FITNESS', '/path1');

INSERT INTO LANGUAGES(ID, LANG_CODE, LABEL, CATEGORY_ID) VALUES (1, 'EN', 'Fashion', 1);
INSERT INTO LANGUAGES(ID, LANG_CODE, LABEL, CATEGORY_ID) VALUES (2, 'AR', 'الموضة', 1);
INSERT INTO LANGUAGES(ID, LANG_CODE, LABEL, CATEGORY_ID) VALUES (3, 'EN', 'Electronics', 2);
INSERT INTO LANGUAGES(ID, LANG_CODE, LABEL, CATEGORY_ID) VALUES (4, 'FR', 'Électronique', 2);
INSERT INTO LANGUAGES(ID, LANG_CODE, LABEL, CATEGORY_ID) VALUES (5, 'EN', 'Health & Fitness', 3);
INSERT INTO LANGUAGES(ID, LANG_CODE, LABEL, CATEGORY_ID) VALUES (6, 'ES', 'Salud y Estado Fisico', 3);
